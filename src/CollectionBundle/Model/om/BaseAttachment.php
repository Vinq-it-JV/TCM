...
abstract class BaseAttachment extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'CollectionBundle\\Model\\AttachmentPeer';
    ...
    public function setUid($v)
    {
        ...
        if ($this->uid !== $v) {
            $this->uid = $v;
            $this->modifiedColumns[] = AttachmentPeer::UID;
        }
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[] = AttachmentPeer::TYPE;
        }
    ...
    public function setOriginalName($v)
    {
        ...
        if ($this->original_name !== $v) {
            ...
            $this->modifiedColumns[] = AttachmentPeer::ORIGINAL_NAME;
        }
    ...
    public function setLinkUrl($v)
    {
        ...
        if ($this->link_url !== $v) {
            $this->link_url = $v;
            $this->modifiedColumns[] = AttachmentPeer::LINK_URL;
        }
    ...
    public function setFilename($v)
    {
        ...
        if ($this->filename !== $v) {
            $this->filename = $v;
            $this->modifiedColumns[] = AttachmentPeer::FILENAME;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AttachmentPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = AttachmentPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(AttachmentPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(AttachmentPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(AttachmentPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->collectionsScheduledForDeletion !== null) {
                if (!$this->collectionsScheduledForDeletion->isEmpty()) {
                    ...
                    foreach ($this->collectionsScheduledForDeletion->getPrimaryKeys(false) as $remotePk) {
            ...
            } elseif ($this->collCollections) {
                foreach ($this->collCollections as $collection) {
                    if ($collection->isModified()) {
                        $collection->save($con);
                    }
                }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AttachmentPeer::UID)) {
        ...
        if ($this->isColumnModified(AttachmentPeer::LINK_URL)) {
            $modifiedColumns[':p' . $index++]  = '`link_url`';
        }
        if ($this->isColumnModified(AttachmentPeer::FILENAME)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AttachmentPeer::FILENAME)) $criteria->add(AttachmentPeer::FILENAME, $this->filename);
        if ($this->isColumnModified(AttachmentPeer::CREATED_AT)) $criteria->add(AttachmentPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(AttachmentPeer::UPDATED_AT)) $criteria->add(AttachmentPeer::UPDATED_AT, $this->updated_at);
    ...
    public function setCollectionAttachments(PropelCollection $collectionAttachments, PropelPDO $con = null)
    {
        ...
        foreach ($collectionAttachmentsToDelete as $collectionAttachmentRemoved) {
            $collectionAttachmentRemoved->setAttachment(null);
        }
    ...
    protected function doAddCollectionAttachment($collectionAttachment)
    {
        ...
        $collectionAttachment->setAttachment($this);
    }
    ...
    public function removeCollectionAttachment($collectionAttachment)
    {
        if ($this->getCollectionAttachments()->contains($collectionAttachment)) {
            ...
            $collectionAttachment->setAttachment(null);
        }
     ...
     * @return PropelObjectCollection|CollectionAttachment[] List of CollectionAttachment objects
     */
    public function getCollectionAttachmentsJoinCollection($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = CollectionAttachmentQuery::create(null, $criteria);
     ...
     *
     * By default this just sets the collCollections collection to an empty collection (like clearCollections());
     * however, you may wish to override this method in your stub class to provide setting appropriate
     * to your application -- for example, setting the initial array to the values stored in database.
     *
     * @return void
    ...
    /**
     * Gets a collection of Collection objects related by a many-to-many relationship
    ...
    /**
     * Sets a collection of Collection objects related by a many-to-many relationship
     * to the current object by way of the collection_attachment cross-reference table.
     * It will also schedule objects for deletion based on a diff between old objects (aka persisted)
     * and new objects from the given Propel collection.
     *
    ...
    public function setCollections(PropelCollection $collections, PropelPDO $con = null)
    {
        ...
        $currentCollections = $this->getCollections(null, $con);

        $this->collectionsScheduledForDeletion = $currentCollections->diff($collections);

        foreach ($collections as $collection) {
            if (!$currentCollections->contains($collection)) {
    ...
    /**
     * Gets the number of Collection objects related by a many-to-many relationship
     * to the current object by way of the collection_attachment cross-reference table.
     *
     * @param Criteria $criteria Optional query object to filter the query
     ...
     * @param PropelPDO $con Optional connection object
     *
     * @return int the number of related Collection objects
     */
    public function countCollections($criteria = null, $distinct = false, PropelPDO $con = null)
    {
        if (null === $this->collCollections || null !== $criteria) {
            if ($this->isNew() && null === $this->collCollections) {
                return 0;
     ...
     *
     * @param  Collection $collection The CollectionAttachment object to relate
     * @return Attachment The current object (for fluent API support)
     */
    public function addCollection(Collection $collection)
    {
        ...
        if (!$this->collCollections->contains($collection)) { // only add it if the **same** object is not already associated
            $this->doAddCollection($collection);
            $this->collCollections[] = $collection;

            if ($this->collectionsScheduledForDeletion and $this->collectionsScheduledForDeletion->contains($collection)) {
                $this->collectionsScheduledForDeletion->remove($this->collectionsScheduledForDeletion->search($collection));
            }
        }
     ...
     */
    protected function doAddCollection(Collection $collection)
    {
        // set the back reference to this object directly as using provided method either results
        // in endless loop or in multiple relations
        if (!$collection->getAttachments()->contains($this)) { $collectionAttachment = new CollectionAttachment();
            $collectionAttachment->setCollection($collection);
            $this->addCollectionAttachment($collectionAttachment);

            $foreignCollection = $collection->getAttachments();
            $foreignCollection[] = $this;
        }
    }

    /**
     * Remove a Collection object to this object
     * through the collection_attachment cross reference table.
     *
     * @param Collection $collection The CollectionAttachment object to relate
     * @return Attachment The current object (for fluent API support)
