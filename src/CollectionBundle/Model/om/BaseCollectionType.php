...
abstract class BaseCollectionType extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CollectionBundle\\Model\\CollectionTypePeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CollectionTypePeer
     */
     ...
     * @return CollectionType The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CollectionTypePeer::ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = CollectionTypePeer::NAME;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = CollectionTypePeer::DESCRIPTION;
        }
    ...
    public function setIcon($v)
    {
        ...
        if ($this->icon !== $v) {
            $this->icon = $v;
            $this->modifiedColumns[] = CollectionTypePeer::ICON;
        }
    ...
    public function setStyle($v)
    {
        ...
        if ($this->style !== $v) {
            $this->style = $v;
            $this->modifiedColumns[] = CollectionTypePeer::STYLE;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = CollectionTypePeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = CollectionTypePeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 7; // 7 = CollectionTypePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CollectionType object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CollectionTypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CollectionTypeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(CollectionTypePeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(CollectionTypePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(CollectionTypePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                CollectionTypePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CollectionTypePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CollectionTypePeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(CollectionTypePeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(CollectionTypePeer::ICON)) {
            $modifiedColumns[':p' . $index++]  = '`icon`';
        }
        if ($this->isColumnModified(CollectionTypePeer::STYLE)) {
        ...
        $sql = sprintf(
            'INSERT INTO `collection_type` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CollectionTypePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CollectionTypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CollectionType'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CollectionType'][$this->getPrimaryKey()] = true;
        $keys = CollectionTypePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CollectionTypePeer::ID)) $criteria->add(CollectionTypePeer::ID, $this->id);
        if ($this->isColumnModified(CollectionTypePeer::NAME)) $criteria->add(CollectionTypePeer::NAME, $this->name);
        if ($this->isColumnModified(CollectionTypePeer::DESCRIPTION)) $criteria->add(CollectionTypePeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(CollectionTypePeer::ICON)) $criteria->add(CollectionTypePeer::ICON, $this->icon);
        if ($this->isColumnModified(CollectionTypePeer::STYLE)) $criteria->add(CollectionTypePeer::STYLE, $this->style);
        if ($this->isColumnModified(CollectionTypePeer::CREATED_AT)) $criteria->add(CollectionTypePeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(CollectionTypePeer::UPDATED_AT)) $criteria->add(CollectionTypePeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(CollectionTypePeer::DATABASE_NAME);
        $criteria->add(CollectionTypePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CollectionType (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CollectionType Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CollectionTypePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CollectionTypePeer();
        }
     ...
     * If this CollectionType is new, it will return
    ...
    public function setCollections(PropelCollection $collections, PropelPDO $con = null)
    {
        ...
        foreach ($collectionsToDelete as $collectionRemoved) {
            $collectionRemoved->setCollectionType(null);
        }
    ...
    protected function doAddCollection($collection)
    {
        ...
        $collection->setCollectionType($this);
    }
     ...
     * Otherwise if this CollectionType is new, it will return
     * an empty collection; or if this CollectionType has previously
     * been saved, it will retrieve related Collections from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in CollectionType.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Collection[] List of Collection objects
     */
    public function getCollectionsJoinStore($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = CollectionQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(CollectionTypePeer::DEFAULT_STRING_FORMAT);
    }
