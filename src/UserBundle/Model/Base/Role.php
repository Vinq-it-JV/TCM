...
use UserBundle\Model\Role as ChildRole;
use UserBundle\Model\RoleQuery as ChildRoleQuery;
use UserBundle\Model\UserRole as ChildUserRole;
use UserBundle\Model\UserRoleQuery as ChildUserRoleQuery;
use UserBundle\Model\Map\RoleTableMap;
...
abstract class Role implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\UserBundle\\Model\\Map\\RoleTableMap';
    ...
    /**
     * Initializes internal state of UserBundle\Model\Base\Role object.
     */
     ...
     * @return $this|\UserBundle\Model\Role The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : RoleTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : RoleTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\UserBundle\\Model\\Role'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\UserBundle\Model\Role
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\UserBundle\Model\Role The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \UserBundle\Model\Role (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \UserBundle\Model\Role Clone of current object.
     * @throws PropelException
     */
