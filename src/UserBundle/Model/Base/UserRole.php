...
abstract class UserRole implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\UserBundle\\Model\\Map\\UserRoleTableMap';
    ...
    /**
     * Initializes internal state of UserBundle\Model\Base\UserRole object.
     */
     ...
     * @return $this|\UserBundle\Model\UserRole The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\UserBundle\\Model\\UserRole'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\UserBundle\Model\UserRole
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\UserBundle\Model\UserRole The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \UserBundle\Model\UserRole (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \UserBundle\Model\UserRole Clone of current object.
     * @throws PropelException
     */
