...
/**
 * This class defines the structure of the 'user_phone' table.
 *
 *
 *
 ...
 */
class UserPhoneTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.UserBundle.Model.map.UserPhoneTableMap';
    ...
    {
        // attributes
        $this->setName('user_phone');
        $this->setPhpName('UserPhone');
        $this->setClassname('UserBundle\\Model\\UserPhone');
