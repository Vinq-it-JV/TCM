...
abstract class BaseUserAddress extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'UserBundle\\Model\\UserAddressPeer';
     ...
     * @return UserAddress The current object (for fluent API support)
     */
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[] = UserAddressPeer::USER_ID;
        }
    ...
    public function setAddressId($v)
    {
        ...
        if ($this->address_id !== $v) {
            $this->address_id = $v;
            $this->modifiedColumns[] = UserAddressPeer::ADDRESS_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = UserAddressPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating UserAddress object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = UserAddressPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = UserAddressQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                UserAddressPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UserAddressPeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`user_id`';
        }
        if ($this->isColumnModified(UserAddressPeer::ADDRESS_ID)) {
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = UserAddressPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = UserAddressPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['UserAddress'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['UserAddress'][serialize($this->getPrimaryKey())] = true;
        $keys = UserAddressPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserAddressPeer::USER_ID)) $criteria->add(UserAddressPeer::USER_ID, $this->user_id);
        if ($this->isColumnModified(UserAddressPeer::ADDRESS_ID)) $criteria->add(UserAddressPeer::ADDRESS_ID, $this->address_id);
    ...
    {
        $criteria = new Criteria(UserAddressPeer::DATABASE_NAME);
        $criteria->add(UserAddressPeer::USER_ID, $this->user_id);
        $criteria->add(UserAddressPeer::ADDRESS_ID, $this->address_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getUserId()) && (null === $this->getAddressId());
    }
     ...
     *
     * @return UserAddressPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new UserAddressPeer();
        }
    ...
    public function getAddress(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAddress === null && ($this->address_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAddress->addUserAddresses($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(UserAddressPeer::DEFAULT_STRING_FORMAT);
    }
