 ...
 * @method CountriesQuery orderByCountryCode($order = Criteria::ASC) Order by the country_code column
 * @method CountriesQuery orderByLanguageCode($order = Criteria::ASC) Order by the language_code column
 * @method CountriesQuery orderByFlag($order = Criteria::ASC) Order by the flag column
 *
 * @method CountriesQuery groupById() Group by the id column
 * @method CountriesQuery groupByName() Group by the name column
 * @method CountriesQuery groupByCountryCode() Group by the country_code column
 * @method CountriesQuery groupByLanguageCode() Group by the language_code column
 * @method CountriesQuery groupByFlag() Group by the flag column
 *
 ...
 *
 * @method CountriesQuery leftJoinUserRelatedByCountry($relationAlias = null) Adds a LEFT JOIN clause to the query using the UserRelatedByCountry relation
 * @method CountriesQuery rightJoinUserRelatedByCountry($relationAlias = null) Adds a RIGHT JOIN clause to the query using the UserRelatedByCountry relation
 * @method CountriesQuery innerJoinUserRelatedByCountry($relationAlias = null) Adds a INNER JOIN clause to the query using the UserRelatedByCountry relation
 *
 * @method CountriesQuery leftJoinUserRelatedByLanguage($relationAlias = null) Adds a LEFT JOIN clause to the query using the UserRelatedByLanguage relation
 * @method CountriesQuery rightJoinUserRelatedByLanguage($relationAlias = null) Adds a RIGHT JOIN clause to the query using the UserRelatedByLanguage relation
 * @method CountriesQuery innerJoinUserRelatedByLanguage($relationAlias = null) Adds a INNER JOIN clause to the query using the UserRelatedByLanguage relation
 *
 * @method CountriesQuery leftJoinAddress($relationAlias = null) Adds a LEFT JOIN clause to the query using the Address relation
 * @method CountriesQuery rightJoinAddress($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Address relation
 * @method CountriesQuery innerJoinAddress($relationAlias = null) Adds a INNER JOIN clause to the query using the Address relation
 *
 ...
 * @method Countries findOneByCountryCode(string $country_code) Return the first Countries filtered by the country_code column
 * @method Countries findOneByLanguageCode(string $language_code) Return the first Countries filtered by the language_code column
 * @method Countries findOneByFlag(string $flag) Return the first Countries filtered by the flag column
 *
 ...
 * @method array findByCountryCode(string $country_code) Return Countries objects filtered by the country_code column
 * @method array findByLanguageCode(string $language_code) Return Countries objects filtered by the language_code column
 * @method array findByFlag(string $flag) Return Countries objects filtered by the flag column
 */
abstract class BaseCountriesQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'UserBundle\\Model\\Countries';
        }
    ...
    {
        $sql = 'SELECT `id`, `name`, `country_code`, `language_code`, `flag` FROM `countries` WHERE `id` = :p0';
        try {
    ...
    public function filterByCountryCode($countryCode = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CountriesPeer::COUNTRY_CODE, $countryCode, $comparison);
    }
    ...
    public function filterByLanguageCode($languageCode = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CountriesPeer::LANGUAGE_CODE, $languageCode, $comparison);
    }
    ...
    public function filterByFlag($flag = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CountriesPeer::FLAG, $flag, $comparison);
    }
     ...
     */
    public function filterByUserRelatedByCountry($user, $comparison = null)
    {
        if ($user instanceof User) {
            return $this
                ->addUsingAlias(CountriesPeer::ID, $user->getCountry(), $comparison);
        } elseif ($user instanceof PropelObjectCollection) {
            return $this
                ->useUserRelatedByCountryQuery()
                ->filterByPrimaryKeys($user->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByUserRelatedByCountry() only accepts arguments of type User or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the UserRelatedByCountry relation
     *
     ...
     * @return CountriesQuery The current query, for fluid interface
     */
    public function joinUserRelatedByCountry($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('UserRelatedByCountry');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'UserRelatedByCountry');
        }
    ...
    /**
     * Use the UserRelatedByCountry relation User object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     */
    public function useUserRelatedByCountryQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinUserRelatedByCountry($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'UserRelatedByCountry', '\UserBundle\Model\UserQuery');
    }
     ...
     * @throws PropelException - if the provided filter is invalid.
     */
    public function filterByUserRelatedByLanguage($user, $comparison = null)
    {
        if ($user instanceof User) {
            return $this
                ->addUsingAlias(CountriesPeer::ID, $user->getLanguage(), $comparison);
        } elseif ($user instanceof PropelObjectCollection) {
            return $this
                ->useUserRelatedByLanguageQuery()
                ->filterByPrimaryKeys($user->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByUserRelatedByLanguage() only accepts arguments of type User or PropelCollection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the UserRelatedByLanguage relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return CountriesQuery The current query, for fluid interface
     */
    public function joinUserRelatedByLanguage($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('UserRelatedByLanguage');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'UserRelatedByLanguage');
        }
    ...
    /**
     * Use the UserRelatedByLanguage relation User object
     *
     * @see       useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @return   \UserBundle\Model\UserQuery A secondary query class using the current class as primary query
     */
    public function useUserRelatedByLanguageQuery($relationAlias = null, $joinType = Criteria::LEFT_JOIN)
    {
        return $this
            ->joinUserRelatedByLanguage($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'UserRelatedByLanguage', '\UserBundle\Model\UserQuery');
    }
    ...
    public function filterByAddress($address, $comparison = null)
    {
        if ($address instanceof Address) {
            return $this
                ->addUsingAlias(CountriesPeer::ID, $address->getCountry(), $comparison);
