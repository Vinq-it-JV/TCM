...
use UserBundle\Model\map\CountriesTableMap;
...
abstract class BaseCountriesPeer
{
    ...
    const OM_CLASS = 'UserBundle\\Model\\Countries';

    /** the related TableMap class for this table */
    const TM_CLASS = 'UserBundle\\Model\\map\\CountriesTableMap';
    ...
    const LANGUAGE_CODE = 'countries.language_code';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'CountryCode', 'LanguageCode', 'Flag', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'countryCode', 'languageCode', 'flag', ),
        BasePeer::TYPE_COLNAME => array (CountriesPeer::ID, CountriesPeer::NAME, CountriesPeer::COUNTRY_CODE, CountriesPeer::LANGUAGE_CODE, CountriesPeer::FLAG, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'COUNTRY_CODE', 'LANGUAGE_CODE', 'FLAG', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'country_code', 'language_code', 'flag', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'CountryCode' => 2, 'LanguageCode' => 3, 'Flag' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'countryCode' => 2, 'languageCode' => 3, 'flag' => 4, ),
        BasePeer::TYPE_COLNAME => array (CountriesPeer::ID => 0, CountriesPeer::NAME => 1, CountriesPeer::COUNTRY_CODE => 2, CountriesPeer::LANGUAGE_CODE => 3, CountriesPeer::FLAG => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'COUNTRY_CODE' => 2, 'LANGUAGE_CODE' => 3, 'FLAG' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'country_code' => 2, 'language_code' => 3, 'flag' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CountriesPeer::COUNTRY_CODE);
            $criteria->addSelectColumn(CountriesPeer::LANGUAGE_CODE);
            $criteria->addSelectColumn(CountriesPeer::FLAG);
        } else {
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCountriesPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \UserBundle\Model\map\CountriesTableMap());
      }
    }
