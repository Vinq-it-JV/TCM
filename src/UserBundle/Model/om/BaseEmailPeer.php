...
use UserBundle\Model\map\EmailTableMap;
...
abstract class BaseEmailPeer
{
    ...
    const OM_CLASS = 'UserBundle\\Model\\Email';
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseEmailPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \UserBundle\Model\map\EmailTableMap());
      }
    }
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += EmailPeer::doOnDeleteCascade(new Criteria(EmailPeer::DATABASE_NAME), $con);
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        try {
            ...
            $c = clone $criteria;
            $affectedRows += EmailPeer::doOnDeleteCascade($c, $con);
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $criteria->add(UserEmailPeer::EMAIL_ID, $obj->getId());
