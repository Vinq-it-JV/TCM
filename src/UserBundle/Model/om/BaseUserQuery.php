 ...
 *
 * @method UserQuery leftJoinStoreMaintenanceLog($relationAlias = null) Adds a LEFT JOIN clause to the query using the StoreMaintenanceLog relation
 * @method UserQuery rightJoinStoreMaintenanceLog($relationAlias = null) Adds a RIGHT JOIN clause to the query using the StoreMaintenanceLog relation
 * @method UserQuery innerJoinStoreMaintenanceLog($relationAlias = null) Adds a INNER JOIN clause to the query using the StoreMaintenanceLog relation
 *
...
abstract class BaseUserQuery extends ModelCriteria
{
    ...
    public function filterByStoreMaintenanceLog($storeMaintenanceLog, $comparison = null)
    {
        if ($storeMaintenanceLog instanceof StoreMaintenanceLog) {
            return $this
                ->addUsingAlias(UserPeer::ID, $storeMaintenanceLog->getMaintenanceBy(), $comparison);
