...
use CompanyBundle\Model\map\CompanyAddressTableMap;
...
abstract class BaseCompanyAddressPeer
{
    ...
    const OM_CLASS = 'CompanyBundle\\Model\\CompanyAddress';

    /** the related TableMap class for this table */
    const TM_CLASS = 'CompanyBundle\\Model\\map\\CompanyAddressTableMap';
    ...
    const COMPANY_ID = 'company_address.company_id';

    /** the column name for the address_id field */
    const ADDRESS_ID = 'company_address.address_id';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('CompanyId', 'AddressId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('companyId', 'addressId', ),
        BasePeer::TYPE_COLNAME => array (CompanyAddressPeer::COMPANY_ID, CompanyAddressPeer::ADDRESS_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('COMPANY_ID', 'ADDRESS_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('company_id', 'address_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('CompanyId' => 0, 'AddressId' => 1, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('companyId' => 0, 'addressId' => 1, ),
        BasePeer::TYPE_COLNAME => array (CompanyAddressPeer::COMPANY_ID => 0, CompanyAddressPeer::ADDRESS_ID => 1, ),
        BasePeer::TYPE_RAW_COLNAME => array ('COMPANY_ID' => 0, 'ADDRESS_ID' => 1, ),
        BasePeer::TYPE_FIELDNAME => array ('company_id' => 0, 'address_id' => 1, ),
        BasePeer::TYPE_NUM => array (0, 1, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(CompanyAddressPeer::COMPANY_ID);
            $criteria->addSelectColumn(CompanyAddressPeer::ADDRESS_ID);
        } else {
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if ($key === null) {
                $key = serialize(array((string) $obj->getCompanyId(), (string) $obj->getAddressId()));
            } // if key === null
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            if (is_object($value) && $value instanceof CompanyAddress) {
                $key = serialize(array((string) $value->getCompanyId(), (string) $value->getAddressId()));
    ...
    /**
     * Method to invalidate the instance pool of all tables related to company_address
    ...
    public static function doCountJoinCompany(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CompanyAddressPeer::COMPANY_ID, CompanyPeer::ID, $join_behavior);
    ...
    public static function doCountJoinAddress(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(CompanyAddressPeer::ADDRESS_ID, AddressPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of CompanyAddress objects pre-filled with their Address objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
     * @return array           Array of CompanyAddress objects.
    ...
    public static function doSelectJoinAddress(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (CompanyAddress) to $obj2 (Address)
                $obj2->addCompanyAddress($obj1);
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key3 !== null) {
                ...
                // Add the $obj1 (CompanyAddress) to the collection in $obj3 (Address)
                $obj3->addCompanyAddress($obj1);
            } // if joined row not null
    ...
    /**
     * Selects a collection of CompanyAddress objects pre-filled with all related objects except Company.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinAllExceptCompany(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = CompanyAddressPeer::getInstanceFromPool($key1))) {
                ...
                // Add the $obj1 (CompanyAddress) to the collection in $obj2 (Address)
                $obj2->addCompanyAddress($obj1);
    ...
    /**
     * Selects a collection of CompanyAddress objects pre-filled with all related objects except Address.
     *
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseCompanyAddressPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \CompanyBundle\Model\map\CompanyAddressTableMap());
      }
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $comparison = $criteria->getComparison(CompanyAddressPeer::COMPANY_ID);
            $value = $criteria->remove(CompanyAddressPeer::COMPANY_ID);
            if ($value) {
                $selectCriteria->add(CompanyAddressPeer::COMPANY_ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(CompanyAddressPeer::TABLE_NAME);
            }

            $comparison = $criteria->getComparison(CompanyAddressPeer::ADDRESS_ID);
            $value = $criteria->remove(CompanyAddressPeer::ADDRESS_ID);
            if ($value) {
                $selectCriteria->add(CompanyAddressPeer::ADDRESS_ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(CompanyAddressPeer::TABLE_NAME);
            }
    ...
    /**
     * Deletes all rows from the company_address table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
     ...
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(CompanyAddressPeer::COMPANY_ID, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(CompanyAddressPeer::ADDRESS_ID, $value[1]));
                $criteria->addOr($criterion);
                // we can invalidate the cache for this single PK
                CompanyAddressPeer::removeInstanceFromPool($value);
            }
        }
     ...
     * @return CompanyAddress
     */
    public static function retrieveByPK($company_id, $address_id, PropelPDO $con = null) {
        $_instancePoolKey = serialize(array((string) $company_id, (string) $address_id));
         if (null !== ($obj = CompanyAddressPeer::getInstanceFromPool($_instancePoolKey))) {
             return $obj;
        }
        ...
        $criteria = new Criteria(CompanyAddressPeer::DATABASE_NAME);
        $criteria->add(CompanyAddressPeer::COMPANY_ID, $company_id);
        $criteria->add(CompanyAddressPeer::ADDRESS_ID, $address_id);
