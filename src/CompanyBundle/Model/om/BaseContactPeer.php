...
use CompanyBundle\Model\map\ContactTableMap;
...
abstract class BaseContactPeer
{
    ...
    const OM_CLASS = 'CompanyBundle\\Model\\Contact';

    /** the related TableMap class for this table */
    const TM_CLASS = 'CompanyBundle\\Model\\map\\ContactTableMap';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (ContactPeer::ID, ContactPeer::USER_ID, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (ContactPeer::ID => 0, ContactPeer::USER_ID => 1, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ContactPeer::USER_ID);
        } else {
    ...
    public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(ContactPeer::USER_ID, UserPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Contact objects pre-filled with their User objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Contact) to $obj2 (User)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Contact) to the collection in $obj2 (User)
                $obj2->addContact($obj1);
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseContactPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \CompanyBundle\Model\map\ContactTableMap());
      }
    }
