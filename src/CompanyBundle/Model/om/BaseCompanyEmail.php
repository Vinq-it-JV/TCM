...
abstract class BaseCompanyEmail extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'CompanyBundle\\Model\\CompanyEmailPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CompanyEmailPeer
     */
     ...
     * @return CompanyEmail The current object (for fluent API support)
     */
    public function setCompanyId($v)
    {
        ...
        if ($this->company_id !== $v) {
            $this->company_id = $v;
            $this->modifiedColumns[] = CompanyEmailPeer::COMPANY_ID;
        }
    ...
    public function setEmailId($v)
    {
        ...
        if ($this->email_id !== $v) {
            $this->email_id = $v;
            $this->modifiedColumns[] = CompanyEmailPeer::EMAIL_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = CompanyEmailPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating CompanyEmail object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aEmail !== null && $this->email_id !== $this->aEmail->getId()) {
            $this->aEmail = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CompanyEmailPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CompanyEmailQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CompanyEmailPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CompanyEmailPeer::COMPANY_ID)) {
            $modifiedColumns[':p' . $index++]  = '`company_id`';
        }
        if ($this->isColumnModified(CompanyEmailPeer::EMAIL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`email_id`';
        }

        $sql = sprintf(
            'INSERT INTO `company_email` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CompanyEmailPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CompanyEmailPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CompanyEmail'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CompanyEmail'][serialize($this->getPrimaryKey())] = true;
        $keys = CompanyEmailPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CompanyEmailPeer::COMPANY_ID)) $criteria->add(CompanyEmailPeer::COMPANY_ID, $this->company_id);
        if ($this->isColumnModified(CompanyEmailPeer::EMAIL_ID)) $criteria->add(CompanyEmailPeer::EMAIL_ID, $this->email_id);
    ...
    {
        $criteria = new Criteria(CompanyEmailPeer::DATABASE_NAME);
        $criteria->add(CompanyEmailPeer::COMPANY_ID, $this->company_id);
        $criteria->add(CompanyEmailPeer::EMAIL_ID, $this->email_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getCompanyId()) && (null === $this->getEmailId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of CompanyEmail (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CompanyEmail Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CompanyEmailPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CompanyEmailPeer();
        }
    ...
    public function getCompany(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCompany === null && ($this->company_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCompany->addCompanyEmails($this);
             */
        }
    ...
    public function getEmail(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aEmail === null && ($this->email_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aEmail->addCompanyEmails($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CompanyEmailPeer::DEFAULT_STRING_FORMAT);
    }
