...
abstract class BaseCompanyType extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'CompanyBundle\\Model\\CompanyTypePeer';
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = CompanyTypePeer::DESCRIPTION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = CompanyTypePeer::NUM_HYDRATE_COLUMNS.
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CompanyTypeQuery::create()
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CompanyTypePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CompanyTypePeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(CompanyTypePeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }

        $sql = sprintf(
            'INSERT INTO `company_type` (%s) VALUES (%s)',
    ...
    {
        if (isset($alreadyDumpedObjects['CompanyType'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CompanyType'][$this->getPrimaryKey()] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CompanyTypePeer::DESCRIPTION)) $criteria->add(CompanyTypePeer::DESCRIPTION, $this->description);
     ...
     * If this CompanyType is new, it will return
    ...
    public function setCompanies(PropelCollection $companies, PropelPDO $con = null)
    {
        ...
        foreach ($companiesToDelete as $companyRemoved) {
            $companyRemoved->setCompanyType(null);
        }
     ...
     * @return PropelObjectCollection|Company[] List of Company objects
     */
    public function getCompaniesJoinRegions($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = CompanyQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(CompanyTypePeer::DEFAULT_STRING_FORMAT);
    }
