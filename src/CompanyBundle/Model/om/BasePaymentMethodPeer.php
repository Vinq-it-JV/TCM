...
use CompanyBundle\Model\map\PaymentMethodTableMap;
...
abstract class BasePaymentMethodPeer
{
    ...
    const OM_CLASS = 'CompanyBundle\\Model\\PaymentMethod';

    /** the related TableMap class for this table */
    const TM_CLASS = 'CompanyBundle\\Model\\map\\PaymentMethodTableMap';
    ...
    const DESCRIPTION = 'payment_method.description';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identity map to hold any loaded instances of PaymentMethod objects.
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (PaymentMethodPeer::ID, PaymentMethodPeer::NAME, PaymentMethodPeer::DESCRIPTION, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (PaymentMethodPeer::ID => 0, PaymentMethodPeer::NAME => 1, PaymentMethodPeer::DESCRIPTION => 2, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PaymentMethodPeer::DESCRIPTION);
        } else {
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      if ($and_clear_all_references) {
        foreach (PaymentMethodPeer::$instances as $instance) {
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BasePaymentMethodPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \CompanyBundle\Model\map\PaymentMethodTableMap());
      }
    }
