...
use CompanyBundle\Model\PaymentMethodPeer;
 ...
 * @method PaymentMethodQuery orderByDescription($order = Criteria::ASC) Order by the description column
 *
 * @method PaymentMethodQuery groupById() Group by the id column
 * @method PaymentMethodQuery groupByName() Group by the name column
 * @method PaymentMethodQuery groupByDescription() Group by the description column
 *
 ...
 * @method PaymentMethod findOneByDescription(string $description) Return the first PaymentMethod filtered by the description column
 *
 ...
 * @method array findByDescription(string $description) Return PaymentMethod objects filtered by the description column
 */
abstract class BasePaymentMethodQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'CompanyBundle\\Model\\PaymentMethod';
        }
    ...
    public static function create($modelAlias = null, $criteria = null)
    {
        ...
        $query = new PaymentMethodQuery(null, null, $modelAlias);
    ...
    {
        $sql = 'SELECT `id`, `name`, `description` FROM `payment_method` WHERE `id` = :p0';
        try {
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(PaymentMethodPeer::ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(PaymentMethodPeer::ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
    ...
    public function filterByDescription($description = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PaymentMethodPeer::DESCRIPTION, $description, $comparison);
    }
