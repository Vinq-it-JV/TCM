...
abstract class BaseCompanyAddress extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'CompanyBundle\\Model\\CompanyAddressPeer';
    ...
    public function setCompanyId($v)
    {
        ...
        if ($this->company_id !== $v) {
            $this->company_id = $v;
            $this->modifiedColumns[] = CompanyAddressPeer::COMPANY_ID;
        }
    ...
    public function setAddressId($v)
    {
        ...
        if ($this->address_id !== $v) {
            $this->address_id = $v;
            $this->modifiedColumns[] = CompanyAddressPeer::ADDRESS_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = CompanyAddressPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CompanyAddressPeer::COMPANY_ID)) {
            $modifiedColumns[':p' . $index++]  = '`company_id`';
        }
        if ($this->isColumnModified(CompanyAddressPeer::ADDRESS_ID)) {
            $modifiedColumns[':p' . $index++]  = '`address_id`';
        }

        $sql = sprintf(
            'INSERT INTO `company_address` (%s) VALUES (%s)',
    ...
    {
        if (isset($alreadyDumpedObjects['CompanyAddress'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CompanyAddress'][serialize($this->getPrimaryKey())] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CompanyAddressPeer::COMPANY_ID)) $criteria->add(CompanyAddressPeer::COMPANY_ID, $this->company_id);
        if ($this->isColumnModified(CompanyAddressPeer::ADDRESS_ID)) $criteria->add(CompanyAddressPeer::ADDRESS_ID, $this->address_id);
    ...
    {
        $criteria = new Criteria(CompanyAddressPeer::DATABASE_NAME);
        $criteria->add(CompanyAddressPeer::COMPANY_ID, $this->company_id);
        $criteria->add(CompanyAddressPeer::ADDRESS_ID, $this->address_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getCompanyId()) && (null === $this->getAddressId());
    }
    ...
    public function getCompany(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCompany === null && ($this->company_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCompany->addCompanyAddresses($this);
             */
        }
    ...
    public function getAddress(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAddress === null && ($this->address_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAddress->addCompanyAddresses($this);
             */
        }
