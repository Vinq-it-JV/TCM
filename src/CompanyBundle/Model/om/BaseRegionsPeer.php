...
use CompanyBundle\Model\map\RegionsTableMap;
...
abstract class BaseRegionsPeer
{
    ...
    const OM_CLASS = 'CompanyBundle\\Model\\Regions';

    /** the related TableMap class for this table */
    const TM_CLASS = 'CompanyBundle\\Model\\map\\RegionsTableMap';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (RegionsPeer::ID, RegionsPeer::CODE, RegionsPeer::NAME, RegionsPeer::DESCRIPTION, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'CODE', 'NAME', 'DESCRIPTION', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'code', 'name', 'description', ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (RegionsPeer::ID => 0, RegionsPeer::CODE => 1, RegionsPeer::NAME => 2, RegionsPeer::DESCRIPTION => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'CODE' => 1, 'NAME' => 2, 'DESCRIPTION' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'code' => 1, 'name' => 2, 'description' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(RegionsPeer::CODE);
            $criteria->addSelectColumn(RegionsPeer::NAME);
            $criteria->addSelectColumn(RegionsPeer::DESCRIPTION);
        } else {
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseRegionsPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \CompanyBundle\Model\map\RegionsTableMap());
      }
    }
