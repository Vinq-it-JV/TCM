 ...
 * @method ContactQuery orderByUserId($order = Criteria::ASC) Order by the user_id column
 *
 * @method ContactQuery groupById() Group by the id column
 * @method ContactQuery groupByUserId() Group by the user_id column
 *
 ...
 *
 * @method ContactQuery leftJoinCompanyContact($relationAlias = null) Adds a LEFT JOIN clause to the query using the CompanyContact relation
 * @method ContactQuery rightJoinCompanyContact($relationAlias = null) Adds a RIGHT JOIN clause to the query using the CompanyContact relation
 * @method ContactQuery innerJoinCompanyContact($relationAlias = null) Adds a INNER JOIN clause to the query using the CompanyContact relation
 *
 ...
 *
 * @method Contact findOneByUserId(int $user_id) Return the first Contact filtered by the user_id column
 *
 * @method array findById(int $id) Return Contact objects filtered by the id column
 * @method array findByUserId(int $user_id) Return Contact objects filtered by the user_id column
 */
abstract class BaseContactQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'CompanyBundle\\Model\\Contact';
        }
    ...
    {
        $sql = 'SELECT `id`, `user_id` FROM `contact` WHERE `id` = :p0';
        try {
    ...
    public function filterByUserId($userId = null, $comparison = null)
    {
        if (is_array($userId)) {
            $useMinMax = false;
            if (isset($userId['min'])) {
                $this->addUsingAlias(ContactPeer::USER_ID, $userId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($userId['max'])) {
                $this->addUsingAlias(ContactPeer::USER_ID, $userId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ContactPeer::USER_ID, $userId, $comparison);
    }
    ...
    public function filterByUser($user, $comparison = null)
    {
        if ($user instanceof User) {
            return $this
                ->addUsingAlias(ContactPeer::USER_ID, $user->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(ContactPeer::USER_ID, $user->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByCompanyContact($companyContact, $comparison = null)
    {
        if ($companyContact instanceof CompanyContact) {
            return $this
                ->addUsingAlias(ContactPeer::ID, $companyContact->getContactId(), $comparison);
