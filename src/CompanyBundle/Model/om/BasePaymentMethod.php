...
abstract class BasePaymentMethod extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'CompanyBundle\\Model\\PaymentMethodPeer';
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = PaymentMethodPeer::DESCRIPTION;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PaymentMethodPeer::DESCRIPTION)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PaymentMethodPeer::DESCRIPTION)) $criteria->add(PaymentMethodPeer::DESCRIPTION, $this->description);
