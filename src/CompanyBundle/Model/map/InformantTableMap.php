...
/**
 * This class defines the structure of the 'informant' table.
 *
 *
 *
 ...
 */
class InformantTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.CompanyBundle.Model.map.InformantTableMap';
    ...
    {
        // attributes
        $this->setName('informant');
        $this->setPhpName('Informant');
        $this->setClassname('CompanyBundle\\Model\\Informant');
