...
abstract class BaseDsTemperatureNotification extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'NotificationBundle\\Model\\DsTemperatureNotificationPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        DsTemperatureNotificationPeer
     */
    ...
    /**
     * Initializes internal state of BaseDsTemperatureNotification object.
     * @see        applyDefaults()
     */
     ...
     * @return DsTemperatureNotification The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = DsTemperatureNotificationPeer::ID;
        }
    ...
    public function setSensor($v)
    {
        ...
        if ($this->sensor !== $v) {
            $this->sensor = $v;
            $this->modifiedColumns[] = DsTemperatureNotificationPeer::SENSOR;
        }
    ...
    public function setTemperature($v)
    {
        ...
        if ($this->temperature !== $v) {
            $this->temperature = $v;
            $this->modifiedColumns[] = DsTemperatureNotificationPeer::TEMPERATURE;
        }
    ...
    public function setReason($v)
    {
        ...
        if ($this->reason !== $v) {
            $this->reason = $v;
            $this->modifiedColumns[] = DsTemperatureNotificationPeer::REASON;
        }
    ...
    public function setIsNotified($v)
    {
        ...
        if ($this->is_notified !== $v) {
            $this->is_notified = $v;
            $this->modifiedColumns[] = DsTemperatureNotificationPeer::IS_NOTIFIED;
        }
    ...
    public function setIsHandled($v)
    {
        ...
        if ($this->is_handled !== $v) {
            $this->is_handled = $v;
            $this->modifiedColumns[] = DsTemperatureNotificationPeer::IS_HANDLED;
        }
    ...
    public function setHandledBy($v)
    {
        ...
        if ($this->handled_by !== $v) {
            $this->handled_by = $v;
            $this->modifiedColumns[] = DsTemperatureNotificationPeer::HANDLED_BY;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = DsTemperatureNotificationPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = DsTemperatureNotificationPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->temperature = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            ...
            return $startcol + 9; // 9 = DsTemperatureNotificationPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating DsTemperatureNotification object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = DsTemperatureNotificationPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = DsTemperatureNotificationQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(DsTemperatureNotificationPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(DsTemperatureNotificationPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(DsTemperatureNotificationPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                DsTemperatureNotificationPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(DsTemperatureNotificationPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(DsTemperatureNotificationPeer::SENSOR)) {
            $modifiedColumns[':p' . $index++]  = '`sensor`';
        }
        if ($this->isColumnModified(DsTemperatureNotificationPeer::TEMPERATURE)) {
            $modifiedColumns[':p' . $index++]  = '`temperature`';
        }
        if ($this->isColumnModified(DsTemperatureNotificationPeer::REASON)) {
            $modifiedColumns[':p' . $index++]  = '`reason`';
        }
        if ($this->isColumnModified(DsTemperatureNotificationPeer::IS_NOTIFIED)) {
            $modifiedColumns[':p' . $index++]  = '`is_notified`';
        }
        if ($this->isColumnModified(DsTemperatureNotificationPeer::IS_HANDLED)) {
            $modifiedColumns[':p' . $index++]  = '`is_handled`';
        }
        if ($this->isColumnModified(DsTemperatureNotificationPeer::HANDLED_BY)) {
        ...
        $sql = sprintf(
            'INSERT INTO `ds_temperature_notification` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = DsTemperatureNotificationPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = DsTemperatureNotificationPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['DsTemperatureNotification'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['DsTemperatureNotification'][$this->getPrimaryKey()] = true;
        $keys = DsTemperatureNotificationPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getSensor(),
            $keys[2] => $this->getTemperature(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setTemperature($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DsTemperatureNotificationPeer::ID)) $criteria->add(DsTemperatureNotificationPeer::ID, $this->id);
        if ($this->isColumnModified(DsTemperatureNotificationPeer::SENSOR)) $criteria->add(DsTemperatureNotificationPeer::SENSOR, $this->sensor);
        if ($this->isColumnModified(DsTemperatureNotificationPeer::TEMPERATURE)) $criteria->add(DsTemperatureNotificationPeer::TEMPERATURE, $this->temperature);
        if ($this->isColumnModified(DsTemperatureNotificationPeer::REASON)) $criteria->add(DsTemperatureNotificationPeer::REASON, $this->reason);
        if ($this->isColumnModified(DsTemperatureNotificationPeer::IS_NOTIFIED)) $criteria->add(DsTemperatureNotificationPeer::IS_NOTIFIED, $this->is_notified);
        if ($this->isColumnModified(DsTemperatureNotificationPeer::IS_HANDLED)) $criteria->add(DsTemperatureNotificationPeer::IS_HANDLED, $this->is_handled);
        if ($this->isColumnModified(DsTemperatureNotificationPeer::HANDLED_BY)) $criteria->add(DsTemperatureNotificationPeer::HANDLED_BY, $this->handled_by);
        if ($this->isColumnModified(DsTemperatureNotificationPeer::CREATED_AT)) $criteria->add(DsTemperatureNotificationPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(DsTemperatureNotificationPeer::UPDATED_AT)) $criteria->add(DsTemperatureNotificationPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(DsTemperatureNotificationPeer::DATABASE_NAME);
        $criteria->add(DsTemperatureNotificationPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of DsTemperatureNotification (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return DsTemperatureNotification Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return DsTemperatureNotificationPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new DsTemperatureNotificationPeer();
        }
    ...
    public function setUser(User $v = null)
    {
        ...
        if ($v !== null) {
            $v->addDsTemperatureNotification($this);
        }
    ...
    public function getUser(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUser === null && ($this->handled_by !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUser->addDsTemperatureNotifications($this);
             */
        }
    ...
    public function getDsTemperatureSensor(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aDsTemperatureSensor === null && ($this->sensor !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aDsTemperatureSensor->addDsTemperatureNotifications($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(DsTemperatureNotificationPeer::DEFAULT_STRING_FORMAT);
    }
