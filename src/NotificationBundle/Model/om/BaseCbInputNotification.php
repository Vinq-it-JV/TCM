...
abstract class BaseCbInputNotification extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'NotificationBundle\\Model\\CbInputNotificationPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        CbInputNotificationPeer
     */
    ...
    /**
     * Initializes internal state of BaseCbInputNotification object.
     * @see        applyDefaults()
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = CbInputNotificationPeer::ID;
        }
    ...
    public function setSensor($v)
    {
        ...
        if ($this->sensor !== $v) {
            $this->sensor = $v;
            $this->modifiedColumns[] = CbInputNotificationPeer::SENSOR;
        }
    ...
    public function setSwitchState($v)
    {
        ...
        if ($this->switch_state !== $v) {
            $this->switch_state = $v;
            $this->modifiedColumns[] = CbInputNotificationPeer::SWITCH_STATE;
        }
    ...
    public function setReason($v)
    {
        ...
        if ($this->reason !== $v) {
            $this->reason = $v;
            $this->modifiedColumns[] = CbInputNotificationPeer::REASON;
        }
    ...
    public function setIsHandled($v)
    {
        ...
        if ($this->is_handled !== $v) {
            $this->is_handled = $v;
            $this->modifiedColumns[] = CbInputNotificationPeer::IS_HANDLED;
        }
    ...
    public function setHandledBy($v)
    {
        ...
        if ($this->handled_by !== $v) {
            $this->handled_by = $v;
            $this->modifiedColumns[] = CbInputNotificationPeer::HANDLED_BY;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = CbInputNotificationPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = CbInputNotificationPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aCbInput !== null && $this->sensor !== $this->aCbInput->getId()) {
            $this->aCbInput = null;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = CbInputNotificationPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = CbInputNotificationQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(CbInputNotificationPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(CbInputNotificationPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(CbInputNotificationPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                CbInputNotificationPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(CbInputNotificationPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(CbInputNotificationPeer::SENSOR)) {
            $modifiedColumns[':p' . $index++]  = '`sensor`';
        }
        if ($this->isColumnModified(CbInputNotificationPeer::SWITCH_STATE)) {
        ...
        if ($this->isColumnModified(CbInputNotificationPeer::HANDLED_BY)) {
        ...
        $sql = sprintf(
            'INSERT INTO `cb_input_notification` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = CbInputNotificationPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = CbInputNotificationPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['CbInputNotification'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CbInputNotification'][$this->getPrimaryKey()] = true;
        $keys = CbInputNotificationPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CbInputNotificationPeer::ID)) $criteria->add(CbInputNotificationPeer::ID, $this->id);
        ...
        if ($this->isColumnModified(CbInputNotificationPeer::UPDATED_AT)) $criteria->add(CbInputNotificationPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(CbInputNotificationPeer::DATABASE_NAME);
        $criteria->add(CbInputNotificationPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of CbInputNotification (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return CbInputNotification Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return CbInputNotificationPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new CbInputNotificationPeer();
        }
    ...
    public function getUser(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUser === null && ($this->handled_by !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUser->addCbInputNotifications($this);
             */
        }
    ...
    {
        if ($this->aCbInput === null && ($this->sensor !== null) && $doQuery) {
            $this->aCbInput = CbInputQuery::create()->findPk($this->sensor, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCbInput->addCbInputNotifications($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(CbInputNotificationPeer::DEFAULT_STRING_FORMAT);
    }
