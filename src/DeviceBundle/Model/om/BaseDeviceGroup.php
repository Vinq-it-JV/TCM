...
abstract class BaseDeviceGroup extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'DeviceBundle\\Model\\DeviceGroupPeer';
    ...
    /**
     * Initializes internal state of BaseDeviceGroup object.
     * @see        applyDefaults()
     */
     ...
     * @return DeviceGroup The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = DeviceGroupPeer::ID;
        }
    ...
    public function setMainStore($v)
    {
        ...
        if ($this->main_store !== $v) {
            $this->main_store = $v;
            $this->modifiedColumns[] = DeviceGroupPeer::MAIN_STORE;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = DeviceGroupPeer::NAME;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[] = DeviceGroupPeer::DESCRIPTION;
        }
    ...
    public function setState($v)
    {
        ...
        if ($this->state !== $v) {
            $this->state = $v;
            $this->modifiedColumns[] = DeviceGroupPeer::STATE;
        }
    ...
    public function setPosition($v)
    {
        ...
        if ($this->position !== $v) {
            $this->position = $v;
            $this->modifiedColumns[] = DeviceGroupPeer::POSITION;
        }
    ...
    public function setIsEnabled($v)
    {
        ...
        if ($this->is_enabled !== $v) {
            $this->is_enabled = $v;
            $this->modifiedColumns[] = DeviceGroupPeer::IS_ENABLED;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = DeviceGroupPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = DeviceGroupPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->main_store = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            ...
            return $startcol + 9; // 9 = DeviceGroupPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating DeviceGroup object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = DeviceGroupPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = DeviceGroupQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(DeviceGroupPeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(DeviceGroupPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(DeviceGroupPeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                DeviceGroupPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(DeviceGroupPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(DeviceGroupPeer::MAIN_STORE)) {
            $modifiedColumns[':p' . $index++]  = '`main_store`';
        }
        if ($this->isColumnModified(DeviceGroupPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(DeviceGroupPeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(DeviceGroupPeer::STATE)) {
            $modifiedColumns[':p' . $index++]  = '`state`';
        }
        if ($this->isColumnModified(DeviceGroupPeer::POSITION)) {
            $modifiedColumns[':p' . $index++]  = '`position`';
        }
        if ($this->isColumnModified(DeviceGroupPeer::IS_ENABLED)) {
        ...
        $sql = sprintf(
            'INSERT INTO `device_group` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = DeviceGroupPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = DeviceGroupPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['DeviceGroup'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['DeviceGroup'][$this->getPrimaryKey()] = true;
        $keys = DeviceGroupPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getMainStore(),
            $keys[2] => $this->getName(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setMainStore($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(DeviceGroupPeer::ID)) $criteria->add(DeviceGroupPeer::ID, $this->id);
        if ($this->isColumnModified(DeviceGroupPeer::MAIN_STORE)) $criteria->add(DeviceGroupPeer::MAIN_STORE, $this->main_store);
        if ($this->isColumnModified(DeviceGroupPeer::NAME)) $criteria->add(DeviceGroupPeer::NAME, $this->name);
        if ($this->isColumnModified(DeviceGroupPeer::DESCRIPTION)) $criteria->add(DeviceGroupPeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(DeviceGroupPeer::STATE)) $criteria->add(DeviceGroupPeer::STATE, $this->state);
        if ($this->isColumnModified(DeviceGroupPeer::POSITION)) $criteria->add(DeviceGroupPeer::POSITION, $this->position);
        if ($this->isColumnModified(DeviceGroupPeer::IS_ENABLED)) $criteria->add(DeviceGroupPeer::IS_ENABLED, $this->is_enabled);
        if ($this->isColumnModified(DeviceGroupPeer::CREATED_AT)) $criteria->add(DeviceGroupPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(DeviceGroupPeer::UPDATED_AT)) $criteria->add(DeviceGroupPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(DeviceGroupPeer::DATABASE_NAME);
        $criteria->add(DeviceGroupPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of DeviceGroup (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return DeviceGroup Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return DeviceGroupPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new DeviceGroupPeer();
        }
    ...
    public function getStore(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aStore === null && ($this->main_store !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aStore->addDeviceGroups($this);
             */
        }
     ...
     * If this DeviceGroup is new, it will return
    ...
    public function setControllerBoxen(PropelCollection $controllerBoxen, PropelPDO $con = null)
    {
        ...
        foreach ($controllerBoxenToDelete as $controllerBoxRemoved) {
            $controllerBoxRemoved->setDeviceGroup(null);
        }
    ...
    protected function doAddControllerBox($controllerBox)
    {
        ...
        $controllerBox->setDeviceGroup($this);
    }
    ...
    public function removeControllerBox($controllerBox)
    {
        if ($this->getControllerBoxen()->contains($controllerBox)) {
            ...
            $controllerBox->setDeviceGroup(null);
        }
     ...
     * Otherwise if this DeviceGroup is new, it will return
     * an empty collection; or if this DeviceGroup has previously
     * been saved, it will retrieve related ControllerBoxen from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in DeviceGroup.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
    ...
    public function setDsTemperatureSensors(PropelCollection $dsTemperatureSensors, PropelPDO $con = null)
    {
        ...
        foreach ($dsTemperatureSensorsToDelete as $dsTemperatureSensorRemoved) {
            $dsTemperatureSensorRemoved->setDeviceGroup(null);
        }
    ...
    protected function doAddDsTemperatureSensor($dsTemperatureSensor)
    {
        ...
        $dsTemperatureSensor->setDeviceGroup($this);
    }
    ...
    public function removeDsTemperatureSensor($dsTemperatureSensor)
    {
        if ($this->getDsTemperatureSensors()->contains($dsTemperatureSensor)) {
            ...
            $dsTemperatureSensor->setDeviceGroup(null);
        }
    ...
    public function setCbInputs(PropelCollection $cbInputs, PropelPDO $con = null)
    {
        ...
        foreach ($cbInputsToDelete as $cbInputRemoved) {
            $cbInputRemoved->setDeviceGroup(null);
        }
    ...
    public function setDeviceCopies(PropelCollection $deviceCopies, PropelPDO $con = null)
    {
        ...
        foreach ($deviceCopiesToDelete as $deviceCopyRemoved) {
            $deviceCopyRemoved->setDeviceGroup(null);
        }
    ...
    protected function doAddDeviceCopy($deviceCopy)
    {
        ...
        $deviceCopy->setDeviceGroup($this);
    }
    ...
    public function removeDeviceCopy($deviceCopy)
    {
        if ($this->getDeviceCopies()->contains($deviceCopy)) {
            ...
            $deviceCopy->setDeviceGroup(null);
        }
    ...
    {
        return (string) $this->exportTo(DeviceGroupPeer::DEFAULT_STRING_FORMAT);
    }
