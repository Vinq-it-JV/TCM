 ...
 * @method UserTitleQuery orderByDescription($order = Criteria::ASC) Order by the description column
 *
 * @method UserTitleQuery groupById() Group by the id column
 * @method UserTitleQuery groupByName() Group by the name column
 * @method UserTitleQuery groupByDescription() Group by the description column
 *
 ...
 * @method UserTitle findOneByDescription(string $description) Return the first UserTitle filtered by the description column
 *
 ...
 * @method array findByDescription(string $description) Return UserTitle objects filtered by the description column
 */
abstract class BaseUserTitleQuery extends ModelCriteria
{
    ...
    public function __construct($dbName = null, $modelName = null, $modelAlias = null)
    {
        ...
        if (null === $modelName) {
            $modelName = 'AdministrationBundle\\Model\\UserTitle';
        }
    ...
    {
        $sql = 'SELECT `id`, `name`, `description` FROM `user_title` WHERE `id` = :p0';
        try {
    ...
    public function filterByDescription($description = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(UserTitlePeer::DESCRIPTION, $description, $comparison);
    }
