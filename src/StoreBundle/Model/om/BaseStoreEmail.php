...
abstract class BaseStoreEmail extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'StoreBundle\\Model\\StoreEmailPeer';
     ...
     * @return StoreEmail The current object (for fluent API support)
     */
    public function setStoreId($v)
    {
        ...
        if ($this->store_id !== $v) {
            $this->store_id = $v;
            $this->modifiedColumns[] = StoreEmailPeer::STORE_ID;
        }
    ...
    public function setEmailId($v)
    {
        ...
        if ($this->email_id !== $v) {
            $this->email_id = $v;
            $this->modifiedColumns[] = StoreEmailPeer::EMAIL_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = StoreEmailPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating StoreEmail object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = StoreEmailPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = StoreEmailQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                StoreEmailPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(StoreEmailPeer::STORE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`store_id`';
        }
        if ($this->isColumnModified(StoreEmailPeer::EMAIL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`email_id`';
        }

        $sql = sprintf(
            'INSERT INTO `store_email` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = StoreEmailPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = StoreEmailPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['StoreEmail'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['StoreEmail'][serialize($this->getPrimaryKey())] = true;
        $keys = StoreEmailPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(StoreEmailPeer::STORE_ID)) $criteria->add(StoreEmailPeer::STORE_ID, $this->store_id);
        if ($this->isColumnModified(StoreEmailPeer::EMAIL_ID)) $criteria->add(StoreEmailPeer::EMAIL_ID, $this->email_id);
    ...
    {
        $criteria = new Criteria(StoreEmailPeer::DATABASE_NAME);
        $criteria->add(StoreEmailPeer::STORE_ID, $this->store_id);
        $criteria->add(StoreEmailPeer::EMAIL_ID, $this->email_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getStoreId()) && (null === $this->getEmailId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of StoreEmail (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return StoreEmail Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return StoreEmailPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new StoreEmailPeer();
        }
    ...
    public function getStore(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aStore === null && ($this->store_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aStore->addStoreEmails($this);
             */
        }
    ...
    public function getEmail(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aEmail === null && ($this->email_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aEmail->addStoreEmails($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(StoreEmailPeer::DEFAULT_STRING_FORMAT);
    }
