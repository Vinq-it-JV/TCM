...
abstract class BaseStoreAddress extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'StoreBundle\\Model\\StoreAddressPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        StoreAddressPeer
     */
     ...
     * @return StoreAddress The current object (for fluent API support)
     */
    public function setStoreId($v)
    {
        ...
        if ($this->store_id !== $v) {
            $this->store_id = $v;
            $this->modifiedColumns[] = StoreAddressPeer::STORE_ID;
        }
    ...
    public function setAddressId($v)
    {
        ...
        if ($this->address_id !== $v) {
            $this->address_id = $v;
            $this->modifiedColumns[] = StoreAddressPeer::ADDRESS_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = StoreAddressPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating StoreAddress object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = StoreAddressPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = StoreAddressQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                StoreAddressPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(StoreAddressPeer::STORE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`store_id`';
        }
        if ($this->isColumnModified(StoreAddressPeer::ADDRESS_ID)) {
            $modifiedColumns[':p' . $index++]  = '`address_id`';
        }

        $sql = sprintf(
            'INSERT INTO `store_address` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = StoreAddressPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = StoreAddressPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['StoreAddress'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['StoreAddress'][serialize($this->getPrimaryKey())] = true;
        $keys = StoreAddressPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(StoreAddressPeer::STORE_ID)) $criteria->add(StoreAddressPeer::STORE_ID, $this->store_id);
        if ($this->isColumnModified(StoreAddressPeer::ADDRESS_ID)) $criteria->add(StoreAddressPeer::ADDRESS_ID, $this->address_id);
    ...
    {
        $criteria = new Criteria(StoreAddressPeer::DATABASE_NAME);
        $criteria->add(StoreAddressPeer::STORE_ID, $this->store_id);
        $criteria->add(StoreAddressPeer::ADDRESS_ID, $this->address_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getStoreId()) && (null === $this->getAddressId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of StoreAddress (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return StoreAddress Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return StoreAddressPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new StoreAddressPeer();
        }
    ...
    public function getStore(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aStore === null && ($this->store_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aStore->addStoreAddresses($this);
             */
        }
    ...
    public function getAddress(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aAddress === null && ($this->address_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAddress->addStoreAddresses($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(StoreAddressPeer::DEFAULT_STRING_FORMAT);
    }
