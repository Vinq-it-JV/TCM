...
abstract class BaseStoreMaintenanceLog extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'StoreBundle\\Model\\StoreMaintenanceLogPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        StoreMaintenanceLogPeer
     */
     ...
     * @var        int
     */
    protected $maintenance_store;

    /**
     * The value for the maintenance_by field.
     * @var        int
     */
    protected $maintenance_by;
    ...
    /**
     * The value for the maintenance_stopped_at field.
     * @var        string
     */
    protected $maintenance_stopped_at;
    ...
    /**
     * Get the [maintenance_store] column value.
     *
     * @return int
     */
    ...
    /**
     * Get the [maintenance_by] column value.
     *
     * @return int
     */
    ...
    /**
     * Get the [optionally formatted] temporal [maintenance_stopped_at] column value.
     *
     *
     * @param string $format The date/time format string (either date()-style or strftime()-style).
     *				 If format is null, then the raw DateTime object will be returned.
     ...
     * @throws PropelException - if unable to parse/validate the date/time value.
     */
    public function getMaintenanceStoppedAt($format = null)
    {
        if ($this->maintenance_stopped_at === null) {
            return null;
        }

        if ($this->maintenance_stopped_at === '0000-00-00 00:00:00') {
            // while technically this is not a default value of null,
            // this seems to be closest in meaning.
            return null;
        }
        ...
        try {
            $dt = new DateTime($this->maintenance_stopped_at);
        } catch (Exception $x) {
            throw new PropelException("Internally stored date/time/timestamp value could not be converted to DateTime: " . var_export($this->maintenance_stopped_at, true), $x);
        }
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = StoreMaintenanceLogPeer::ID;
        }
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[] = StoreMaintenanceLogPeer::TYPE;
        }

        if ($this->aMaintenanceType !== null && $this->aMaintenanceType->getId() !== $v) {
     ...
     * @return StoreMaintenanceLog The current object (for fluent API support)
     */
    public function setMaintenanceStore($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->maintenance_store !== $v) {
            $this->maintenance_store = $v;
            $this->modifiedColumns[] = StoreMaintenanceLogPeer::MAINTENANCE_STORE;
        }
    ...
    /**
     * Set the value of [maintenance_by] column.
     *
     * @param  int $v new value
     * @return StoreMaintenanceLog The current object (for fluent API support)
     */
    public function setMaintenanceBy($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->maintenance_by !== $v) {
            $this->maintenance_by = $v;
            $this->modifiedColumns[] = StoreMaintenanceLogPeer::MAINTENANCE_BY;
        }
    ...
    public function setMaintenanceStartedAt($v)
    {
        ...
        if ($this->maintenance_started_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = StoreMaintenanceLogPeer::MAINTENANCE_STARTED_AT;
            }
    ...
    /**
     * Sets the value of [maintenance_stopped_at] column to a normalized version of the date/time value specified.
     *
     * @param mixed $v string, integer (timestamp), or DateTime value.
     *               Empty strings are treated as null.
     * @return StoreMaintenanceLog The current object (for fluent API support)
     */
    public function setMaintenanceStoppedAt($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->maintenance_stopped_at !== null || $dt !== null) {
            $currentDateAsString = ($this->maintenance_stopped_at !== null && $tmpDt = new DateTime($this->maintenance_stopped_at)) ? $tmpDt->format('Y-m-d H:i:s') : null;
            $newDateAsString = $dt ? $dt->format('Y-m-d H:i:s') : null;
            if ($currentDateAsString !== $newDateAsString) {
                $this->maintenance_stopped_at = $newDateAsString;
                $this->modifiedColumns[] = StoreMaintenanceLogPeer::MAINTENANCE_STOPPED_AT;
            }
        } // if either are not null


        return $this;
    } // setMaintenanceStoppedAt()
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aUser !== null && $this->maintenance_by !== $this->aUser->getId()) {
            $this->aUser = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = StoreMaintenanceLogPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = StoreMaintenanceLogQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                StoreMaintenanceLogPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aMaintenanceType !== null) {
                if ($this->aMaintenanceType->isModified() || $this->aMaintenanceType->isNew()) {
                    $affectedRows += $this->aMaintenanceType->save($con);
                }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(StoreMaintenanceLogPeer::ID)) {
        ...
        if ($this->isColumnModified(StoreMaintenanceLogPeer::MAINTENANCE_BY)) {
            $modifiedColumns[':p' . $index++]  = '`maintenance_by`';
        }
        if ($this->isColumnModified(StoreMaintenanceLogPeer::MAINTENANCE_STARTED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`maintenance_started_at`';
        }
        if ($this->isColumnModified(StoreMaintenanceLogPeer::MAINTENANCE_STOPPED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`maintenance_stopped_at`';
        }

        $sql = sprintf(
            'INSERT INTO `store_maintenance_log` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`maintenance_store`':
                        ...
                        break;
                    case '`maintenance_by`':
                        $stmt->bindValue($identifier, $this->maintenance_by, PDO::PARAM_INT);
                        break;
                    case '`maintenance_started_at`':
                        $stmt->bindValue($identifier, $this->maintenance_started_at, PDO::PARAM_STR);
                        break;
                    case '`maintenance_stopped_at`':
                        $stmt->bindValue($identifier, $this->maintenance_stopped_at, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aMaintenanceType !== null) {
                if (!$this->aMaintenanceType->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aMaintenanceType->getValidationFailures());
                }
            }
            ...
            if (($retval = StoreMaintenanceLogPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = StoreMaintenanceLogPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['StoreMaintenanceLog'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['StoreMaintenanceLog'][$this->getPrimaryKey()] = true;
        $keys = StoreMaintenanceLogPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getType(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(StoreMaintenanceLogPeer::MAINTENANCE_STOPPED_AT)) $criteria->add(StoreMaintenanceLogPeer::MAINTENANCE_STOPPED_AT, $this->maintenance_stopped_at);
    ...
    {
        $criteria = new Criteria(StoreMaintenanceLogPeer::DATABASE_NAME);
        $criteria->add(StoreMaintenanceLogPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of StoreMaintenanceLog (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setMaintenanceStoppedAt($this->getMaintenanceStoppedAt());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return StoreMaintenanceLog Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return StoreMaintenanceLogPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new StoreMaintenanceLogPeer();
        }
    ...
    /**
     * Declares an association between this object and a MaintenanceType object.
     *
     * @param                  MaintenanceType $v
     * @return StoreMaintenanceLog The current object (for fluent API support)
     * @throws PropelException
     */
    public function setMaintenanceType(MaintenanceType $v = null)
    {
        if ($v === null) {
            $this->setType(NULL);
        } else {
        ...
        $this->aMaintenanceType = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the MaintenanceType object, it will not be re-added.
        if ($v !== null) {
    ...
    /**
     * Get the associated MaintenanceType object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return MaintenanceType The associated MaintenanceType object.
     * @throws PropelException
     */
    public function getMaintenanceType(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aMaintenanceType === null && ($this->type !== null) && $doQuery) {
            $this->aMaintenanceType = MaintenanceTypeQuery::create()->findPk($this->type, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aMaintenanceType->addStoreMaintenanceLogs($this);
             */
        }

        return $this->aMaintenanceType;
    }
    ...
    {
        if ($v === null) {
            $this->setMaintenanceStore(NULL);
        } else {
            $this->setMaintenanceStore($v->getId());
        }
    ...
    {
        if ($this->aStore === null && ($this->maintenance_store !== null) && $doQuery) {
            $this->aStore = StoreQuery::create()->findPk($this->maintenance_store, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aStore->addStoreMaintenanceLogs($this);
             */
        }
    ...
    {
        if ($v === null) {
            $this->setMaintenanceBy(NULL);
        } else {
            $this->setMaintenanceBy($v->getId());
        }
    ...
    {
        if ($this->aUser === null && ($this->maintenance_by !== null) && $doQuery) {
            $this->aUser = UserQuery::create()->findPk($this->maintenance_by, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUser->addStoreMaintenanceLogs($this);
             */
        }
    ...
    public function clear()
    {
        ...
        $this->maintenance_stopped_at = null;
        $this->alreadyInSave = false;
        $this->alreadyInValidation = false;
    ...
    {
        return (string) $this->exportTo(StoreMaintenanceLogPeer::DEFAULT_STRING_FORMAT);
    }
