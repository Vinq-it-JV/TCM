...
abstract class BaseStockImage extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'StoreBundle\\Model\\StockImagePeer';
     ...
     * @return StockImage The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = StockImagePeer::ID;
        }
    ...
    public function setUid($v)
    {
        ...
        if ($this->uid !== $v) {
            $this->uid = $v;
            $this->modifiedColumns[] = StockImagePeer::UID;
        }
    ...
    public function setOriginalName($v)
    {
        ...
        if ($this->original_name !== $v) {
            ...
            $this->modifiedColumns[] = StockImagePeer::ORIGINAL_NAME;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = StockImagePeer::NAME;
        }
    ...
    public function setLinkUrl($v)
    {
        ...
        if ($this->link_url !== $v) {
            $this->link_url = $v;
            $this->modifiedColumns[] = StockImagePeer::LINK_URL;
        }
    ...
    public function setFilename($v)
    {
        ...
        if ($this->filename !== $v) {
            $this->filename = $v;
            $this->modifiedColumns[] = StockImagePeer::FILENAME;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = StockImagePeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = StockImagePeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 8; // 8 = StockImagePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating StockImage object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = StockImagePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = StockImageQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(StockImagePeer::CREATED_AT)) {
                    $this->setCreatedAt(time());
                }
                if (!$this->isColumnModified(StockImagePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(StockImagePeer::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                StockImagePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(StockImagePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(StockImagePeer::UID)) {
            $modifiedColumns[':p' . $index++]  = '`uid`';
        }
        if ($this->isColumnModified(StockImagePeer::ORIGINAL_NAME)) {
            $modifiedColumns[':p' . $index++]  = '`original_name`';
        }
        if ($this->isColumnModified(StockImagePeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(StockImagePeer::LINK_URL)) {
            $modifiedColumns[':p' . $index++]  = '`link_url`';
        }
        if ($this->isColumnModified(StockImagePeer::FILENAME)) {
        ...
        $sql = sprintf(
            'INSERT INTO `stock_image` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = StockImagePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = StockImagePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['StockImage'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['StockImage'][$this->getPrimaryKey()] = true;
        $keys = StockImagePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getUid(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(StockImagePeer::ID)) $criteria->add(StockImagePeer::ID, $this->id);
        if ($this->isColumnModified(StockImagePeer::UID)) $criteria->add(StockImagePeer::UID, $this->uid);
        if ($this->isColumnModified(StockImagePeer::ORIGINAL_NAME)) $criteria->add(StockImagePeer::ORIGINAL_NAME, $this->original_name);
        if ($this->isColumnModified(StockImagePeer::NAME)) $criteria->add(StockImagePeer::NAME, $this->name);
        if ($this->isColumnModified(StockImagePeer::LINK_URL)) $criteria->add(StockImagePeer::LINK_URL, $this->link_url);
        if ($this->isColumnModified(StockImagePeer::FILENAME)) $criteria->add(StockImagePeer::FILENAME, $this->filename);
        if ($this->isColumnModified(StockImagePeer::CREATED_AT)) $criteria->add(StockImagePeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(StockImagePeer::UPDATED_AT)) $criteria->add(StockImagePeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(StockImagePeer::DATABASE_NAME);
        $criteria->add(StockImagePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of StockImage (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return StockImage Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return StockImagePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new StockImagePeer();
        }
     ...
     * If this StockImage is new, it will return
    ...
    public function setStoreStocks(PropelCollection $storeStocks, PropelPDO $con = null)
    {
        ...
        foreach ($storeStocksToDelete as $storeStockRemoved) {
            $storeStockRemoved->setStockImage(null);
        }
     ...
     * Otherwise if this StockImage is new, it will return
     * an empty collection; or if this StockImage has previously
     * been saved, it will retrieve related StoreStocks from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in StockImage.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|StoreStock[] List of StoreStock objects
     */
    public function getStoreStocksJoinStore($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = StoreStockQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(StockImagePeer::DEFAULT_STRING_FORMAT);
    }
