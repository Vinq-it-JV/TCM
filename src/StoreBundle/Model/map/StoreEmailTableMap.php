...
/**
 * This class defines the structure of the 'store_email' table.
 *
 *
 *
 ...
 */
class StoreEmailTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.StoreBundle.Model.map.StoreEmailTableMap';
    ...
    {
        // attributes
        $this->setName('store_email');
        $this->setPhpName('StoreEmail');
        $this->setClassname('StoreBundle\\Model\\StoreEmail');
