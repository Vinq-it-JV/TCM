...
/**
 * This class defines the structure of the 'store_address' table.
 *
 *
 *
 ...
 */
class StoreAddressTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.StoreBundle.Model.map.StoreAddressTableMap';
    ...
    public function initialize()
    {
        ...
        $this->setPhpName('StoreAddress');
        $this->setClassname('StoreBundle\\Model\\StoreAddress');
